...
mpirun  -np  5   gmx_mpi mdrun -v -deffnm nvt -pin on -ntomp 8 &&

mpirun  -np 1    gmx_mpi grompp -f md_pull_equitst.mdp -c nvt.gro -r nvt.gro -p topol.top -o npt1.tpr  &&
mpirun  -np 5   gmx_mpi mdrun -deffnm npt1    -ntomp 8   &&


mpirun  -np 1    gmx_mpi grompp -f md_pull_equitst2.mdp -c npt1.gro -r npt1.gro -p topol.top -o npt2.tpr  &&
mpirun  -np 5   gmx_mpi mdrun -deffnm npt2    -ntomp 8
'

mpirun  -np 5   gmx_mpi mdrun -deffnm npt2    -ntomp 8  -cpi  npt2.cpt  -append
